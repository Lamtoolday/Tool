...
print(f"{red}├─────┼────────────────────────────────────┼─────────┼─────────┤")
print(f"{red}│ {vang} 6 {red} │{lam} TTC Facebook        {red}               │{tim} ONLINE {red} │ {lam} [1.0]  {red}│")
print(f"{red}├─────┼────────────────────────────────────┼─────────┼─────────┤")
...
print(f"{red}├─────┼────────────────────────────────────┼─────────┼─────────┤")
print(f"{red}│ {vang} 12{red} │{lam} QUAY LẠI        {red}                   │{tim}   =.=   {red}│ {lam}  NEXT {red} │")
print(f"{red}└─────┴────────────────────────────────────┴─────────┴─────────┘\n")
chon = input(f"{thanh_dep}{luc}Nhập Lựa Chọn{trang}: ")
os.system("cls" if os.name == "nt" else "clear")
try:
        if chon == '1':
                run = requests.get(f'lamtool.x10.mx/facebook.py').text
        elif chon == '2':
                run = requests.get(f'https://pastebin.com/raw/bvgBqzaS').text
        elif chon == '3':
                run = requests.get(f'https://pastebin.com/raw/epHspQGv').text
        elif chon == '4':
                run = requests.get(f'https://pastebin.com/raw/4AmLJJx4').text
        elif chon == '5':
                run = requests.get(f'https://pastebin.com/raw/GWKnBvWm').text
        elif chon == '12':
