...
\033[1;34m╚══════════════════════════════════════════════════════════════════════╝┘"""
    ...
    def ndp_delay_tool(self, p):
        while(p>1):
            p=p-1
            print(f'[ 🤖 ASCII 🤖][|][LO......][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🤖 ASCII 🤖][/][LOA.....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🤖 ASCII 🤖][-][LOAD....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🤖 ASCII 🤖][+][LOADI...][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🤖 ASCII 🤖][\][LOADIN..][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🤖ASCII 🤖][|][LOADING.][{p}]','     ',end='\r');sleep(1/6)
