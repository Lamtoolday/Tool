...
def OOO00OO0000OOO00O (O0O00O00OOOO0OOO0 ):
	for OOOO0OOOO0000OOOO in range (O0O00O00OOOO0OOO0 ,-1 ,-1 ):
		print (f'{luc}Đang hoạt động chống block sẽ chạy lại sau {vang}{OOOO0OOOO0000OOOO} {luc}giây  ',end ='\r');sleep (1 );print (f'                                                        ',end ='\r')
def O0O0OO0OOO0OO00O0 (OOOO00OOO00OO0OOO ,O0O0O000O0O0OO0O0 ):
	...
	try :
		for O00OOOO0O00OO0O0O in range (OOOOOOOO00O00000O ,-1 ,-1 ):
			print (f'{trang}[{do}FRIVE{trang}]['+vang+str (O00OOOO0O00OO0O0O )+trang+']           ',end ='\r')
			sleep (1 )
	except :
...
def OO000000O000OOO00 (OO0000000O0OOO000 ,OO000O0O000OO0OOO ,OOOO00OO0O00O0OO0 ,O0OO000O0O0O0000O ,O0OO0O000OO000OO0 ):
	...
	print (f'{trang}[{vang}{OO0000000O0OOO000}{trang}] {trang}| {vang}{O0O00OOO0O0O000OO} {trang}| {xnhac}{OOOO00OO0O00O0OO0} {trang}| {luc}{OOOOO00000OO00O0O} {trang}| {vang}{O0OO000O0O0O0000O} {trang}| {luc}{O0OO0O000OO000OO0} {trang}|')
def O0OOO00OO0OOO0OO0 (OO0O000OOO0OO00OO ,OO0O0000OO0OO0OO0 ):
	...
	print (f'{trang}[{do}X{trang}] | {vang}{O00O000O0O00OO0O0} {trang}| {vang}{OO0O0000OO0OO0OO0} {trang}| {vang}{O00000OOOO00OO00O} {trang}| {do}ERROR',end ='\r');sleep (2 );print (f'                                                   ',end ='\r')
def O000O0O00OOOO00O0 ():
	O0OO0O0O00O0O0OOO =0 
	while True :
		O0OO0O0O00O0O0OOO +=1 
		OO000O00O00OOO00O =input (f'{luc}Nhập Cookie Instagram Thứ {O0OO0O0O00O0O0OOO}{trang}: ')
		...
		if OOO00000O00OO000O !=False :
			...
			print (f'{do}Cookie Instagram Die ! Vui Lòng Nhập Lại !!!')
			OOO0O00OO0OOOOOO0 (14 )
			O0OO0O0O00O0O0OOO -=1 
...
def OOO0O00OO0OOOOOO0 (OO000O0O0OOOOO0OO ):
	O00OOO0000OO0OOOO =f"{hong}────"*OO000O0O0OOOOO0OO 
...
def OOO0O000000O00O00 ():
	...
	while True :
		if os .path .exists ('configtds.txt'):
			...
			try :
				print (f'{luc}Nhập {trang}[{vang}1{trang}] {xnhac}Giữ Lại Tài Khoản '+O000000O0OOOOO00O ['user'])
				print (f'{luc}Nhập {trang}[{vang}2{trang}] {xnhac}Nhập Access_Token TDS Mới')
				O0OO0OOOOO0O0O0OO =input (f'{luc}Nhập {trang}: ')
				if O0OO0OOOOO0O0O0OO =='2':
					os .remove ('configtds.txt')
				elif O0OO0OOOOO0O0O0OO =='1':
					pass 
				else :
					print (f'{do}Lựa chọn không xác định !!!');OOO0O00OO0OOOOOO0 (14 )
					continue 
			except :
				os .remove ('configtds.txt')
		if not os .path .exists ('configtds.txt'):
			O00OOOO00O00O00O0 =input (f'{luc}Nhập Access_Token TDS{trang}: ')
		...
		try :
			...
			print (f' {xanhbien}Đăng Nhập Thành Công ')
			break 
		except :
			print (f'{do}Access Token Không Hợp Lệ! Xin Thử Lại ')
			os .remove ('configtds.txt')
			continue 
	OOO0O00OO0OOOOOO0 (14 )
	while True :
		if os .path .exists ('CookieIG.txt'):
			print (f'{luc}Nhập {trang}[{vang}1{trang}] {xnhac}Sử Dụng Cookie Instagram Đã Lưu ')
			print (f'{luc}Nhập {trang}[{vang}2{trang}] {xnhac}Nhập Cookie Instagram Mới')
			O0OO0OOOOO0O0O0OO =input (f'{luc}Vui Lòng Nhập{trang}: ')
			if O0OO0OOOOO0O0O0OO =='1':
				print (f'{luc}Đang Lấy Dữ Liệu Đã Lưu');sleep (1 )
				...
				print (f'{do}Lựa Chọn Không Xác Định.');OOO0O00OO0OOOOOO0 (14 );continue 
		if not os .path .exists ('CookieIG.txt'):
			...
			break 
	print (f'{luc}Tên Tài Khoản{trang}: {vang}',O0O000O0O00OOOOOO )
	print (f'{luc}Xu Hiện Tại{trang}: {vang}',O0OOO00O0000000OO )
	print (f'{luc}Xu Bị Trừ{trang}: {vang}',O0OO0O00000OOOO0O )
	OOO0O00OO0OOOOOO0 (14 )
	print (f'{luc}Nhập {trang}[{vang}1{trang}] {luc}Để Chạy Nhiệm Vụ Like')
	print (f'{luc}Nhập {trang}[{vang}1{trang}] {luc}Để Chạy Nhiệm Vụ Follow')
	print (f'{luc}Nhập {trang}[{vang}1{trang}] {luc}Để Chạy Nhiệm Vụ Comment')
	print (f'{luc}Có Thể Chọn Nhiều Nhiệm Vụ (Ví Dụ 1+2+3){trang}')
	O00O00000OO000O00 =input (f'{luc}Nhập Số Để Chạy Nhiệm Vụ{trang}: ')
	OOO0O00OO0OOOOOO0 (14 )
	O0O00O0OO00000OOO =int (input (f'{luc}Nhập Delay Min{trang}: '))
	O0O0000OOOOO0O00O =int (input (f'{luc}Nhập Delay Max{trang}: '))
	print (f'{luc}Sau {trang}____ {luc}Nhiệm Vụ Thì Kích Hoạt Chống Block.',end ='\r')
	O0OOO0O0OOO00O0O0 =int (input (f'{luc}Sau{trang} '))
	print (f'{luc}Sau {trang}{O0OOO0O0OOO00O0O0} {luc}Nhiệm Vụ Nghỉ Ngơi {trang}____{trang} {luc}Giây       ',end ='\r')
	OOO000OO0OOOO0O0O =int (input (f'{luc}Sau {trang}{O0OOO0O0OOO00O0O0} {luc}Nhiệm Vụ Nghỉ Ngơi '))
	O0O0OO0O0O0OO0OOO =int (input (f'{luc}Sau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick{trang}: '))
	while True :
		...
		for OOOOOOOO0O0OOOO0O in O0OO0O00O0000000O :
			...
			if O00000O00O00O0000 !=False :
				...
				print (f'{do}Cookie Tài Khoản {OOO00O000O0OOO000} Die',end ='\r');sleep (3 );print (f'                                     ',end ='\r')
			...
			if O0O0000OOO0OOOO00 ==True :
				OOO0O00OO0OOOOOO0 (14 )
				print (f'{xnhac}Đang Cấu Hình ID: {vang}{OOO00O000O0OOO000} {trang}| {xnhac}User: {vang}{O0O000O0O00OOOOOO}{trang} |')
				OOO0O00OO0OOOOOO0 (14 )
			else :
				print (f'{xnhac}Cấu Hình Thất Bại ID: {vang}{OOO00O000O0OOO000} {trang}| {xnhac}User: {vang}{O0O000O0O00OOOOOO} | ',end ='\r')
				continue 
			OOOO0OO00OO00OO0O =0 
			while True :
						...
						if len (OOOOO000OOOO0OO0O )==0 :
							...
							for O00OOOOOO00OOO00O in OOOOO000OOOO0OO0O :
								...
								if O000O0000O000O000 ==False :
									...
									try :
										...
										if OO0000OO0O0OO0OOO %O0O0OO0O0O0OO0OOO ==0 :
											OOO0O00OO0OOOOOO0 (14 );print (f'{xnhac}Số Xu Hiện Tại: {vang}{O0OOO00O0000000OO} {trang}| {xnhac}Số Tài Khoản Instagram {vang}{len(O0OO0O00O0000000O)}');OOO0O00OO0OOOOOO0 (14 );OOOO0OO00OO00OO0O =1 ;break 
								...
								if OO0OO0O000OO0O00O >=5 :
									O00000O00O00O0000 =OOOO0OO00O000OO00 .name ()
									if O00000O00O00O0000 ==False :
										print (f'  {do}Cookie Tài Khoản {O0O000O0O00OOOOOO} Đã Bị Out !!!                ')
									else :
										print (f' {do}Tài Khoản {O0O000O0O00OOOOOO} Đã Bị Block Like !!!					')
									O0OO0O00O0000000O .remove (OOOOOOOO0O0OOOO0O )
									OOOO0OO00OO00OO0O =1 
									break 
							...
							for O00OOOOOO00OOO00O in O000OO0O0OO0OO000 :
								...
								if OOOO00O00O00O0OOO >=5 :
									...
									if O00000O00O00O0000 ==False :
										...
										print (f' {do}Tài Khoản {O0O000O0O00OOOOOO} Đã Bị Block Follow !!!					')
									O0OO0O00O0000000O .remove (OOOOOOOO0O0OOOO0O )
									OOOO0OO00OO00OO0O =1 
									break 
				if OOOO0OO00OO00OO0O ==1 :
