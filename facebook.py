...
class Facebook_Api (object):
	...
	def share(self, id, nd="Tôi Yêu Bạn"):
		try:
			url = requests.get('https://mbasic.facebook.com/'+id, headers=self.headers).url
...
def nghingoi(delaymin, delaymax):
	...
	#	Write.Print('[ASCII]['+str(i)+']                                                                ',Colors.green_to_blue,interval=0.0001,end='\r')
		sleep(1)
		...
		if os.path.exists('configtds.txt'):
			...
			try:
				...
				if chon == '2':
					...
					Write.Print('Lựa chọn không xác định !!!\n',Colors.green_to_red,interval=0.0001);frive(14)
					continue 
			except:
				os.remove('configtds.txt')
	...
	while True:
		if os.path.exists('Cookie_FB.txt'):
			...
			if chon == '1':
				...
				os.remove('Cookie_FB.txt'); frive(14)
			else:
				Write.Print('Lựa Chọn Không Xác Định.\n',Colors.green_to_red,interval=0.0001); frive(14); continue
	...
	while True:
		...
		for cookie in list_cookie:
			...
			if name != 0:
				...
				Write.Print(f'Cookie Tài Khoản {id} Die',Colors.green_to_yellow,interval=0.0001, end='\r');sleep(3); Write.Print('                                     ', end = '\r' )
			...
			######
				...
				if nvlike == 1:
					...
					if listlike == False:
						Write.Print('Không Get Được Nhiệm Vụ Like              ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvlike = 0
						...
						if len(listlike) == 0:
							Write.Print('Hết Nhiệm Vụ Like                             ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvlike = 0
						else:
							...
							for x in listlike:
								...
								if like == False:
									...
									try:
										...
										loilike = 0
										if dem % doinick == 0:
											frive(14); Write.Print(f'Số Xu Hiện Tại: {xu} | Số Tài Khoản Facebook {len(list_cookie)}\n',Colors.green_to_red,interval=0.0001); frive(14); ntool = 1; break
										if dem % nvblock == 0:
											chongblock(delaybl)
										else:
				...
				if nvlike2 == 1:
					...
					if listlike2 == False:
						Write.Print('Không Get Được Nhiệm Vụ Like 2                        ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvlike2 = 0
						...
						if len(listlike2) == 0:
							Write.Print('Hết Nhiệm Vụ Like 2                                  ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvlike2 = 0
						else:
				...
				if nvlike3 == 1:
					...
					if listlike3 == False:
						Write.Print('Không Get Được Nhiệm Vụ Like 3                        \n',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvlike3 = 0
						...
						if len(listlike3) == 0:
							Write.Print('Hết Nhiệm Vụ Like 3                                  ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvlike3 = 0
						else:
				...
				if nvcmt == 1:
					...
					if listcmt == False:
						Write.Print('Không Get Được Nhiệm Vụ Comment                     ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvcmt = 0
						...
						if len(listcmt) == 0:
							Write.Print('Hết Nhiệm Vụ Comment                                 \n',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvcmt = 0
						else:
				...
				if nvshare == 1:
					...
					if listshare == False:
						Write.Print('Không Get Được Nhiệm Vụ Share                       ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvshare = 0
						...
						if len(listshare) == 0:
							Write.Print('Hết Nhiệm Vụ Share ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvshare = 0
						else:
				...
				if nvcx == 1:
					...
					if listcx == False:
						Write.Print('Không Get Được Nhiệm Vụ Cảm Xúc                             ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvcx = 0
						...
						listcx = listcx.json()
						if len(listcx) == 0:
							Write.Print('Hết Nhiệm Vụ Cảm Xúc                                 \n',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvcx = 0
						else:
				...
				if nvfollow == 1:
					...
					if listfollow == False:
						Write.Print('Không Get Được Nhiệm Vụ Follow                      ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvfollow = 0
						listfollow = []
						...
						if len(listfollow) == 0:
							Write.Print('Hết Nhiệm Vụ Follow                                    \n',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvfollow = 0
						else:
				...
				if nvpage == 1:
					...
					if listpage == False:
						Write.Print('Không Get Được Nhiệm Vụ Like Page                 ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvpage = 0
						listpage = []
						...
						if len(listpage) == 0:
							Write.Print('Hết Nhiệm Vụ Like Page                                 \n',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							nvpage = 0
						else:
				...
				if nvcxcmt == 1:
					...
					if listcxcmt == False:
						Write.Print('Không Get Được Nhiệm Vụ Cảm Xúc Comment ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvcxcmt = 0
						listcxcmt = []
						...
						if len(listcxcmt) == 0:
							Write.Print('Hết Nhiệm Vụ Cảm Xúc Comment                       ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							listcxcmt = 0
						else:
				...
				if nvgroup == 1:
					...
					if listgroup == False:
						Write.Print('Không Get Được Nhiệm Vụ Group                               ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
						nvgroup = 0
						listgroup = []
						...
						if len(listgroup) == 0:
							Write.Print('Hết Nhiệm Vụ Group                                 ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
							listgroup = 0
						else:
